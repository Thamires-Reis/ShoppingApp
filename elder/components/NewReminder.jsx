    ...
    switch (value) {
      ...
      case "Monthly":
        trigger = {
          date: date,
          repeats: true,
          intervalMs: 2592000000, // 30 days in milliseconds (approximately)
        };
        break;
      default:
        trigger = new Date();
  ...
  return (
    ...
    >
      ...
      >
        ...
        <>
          ...
          >
            ...
            >
              <Text style={tailwind`text-white uppercase`}>Daily</Text>
              <RadioButton color="#fff" value="Daily" />
            </View>
            <View
              style={tailwind`flex flex-row w-full items-center justify-between  `}
            >
              <Text style={tailwind`text-white uppercase`}>Weekly</Text>
              <RadioButton color="#fff" value="Weekly" />
            </View>
            <View
              style={tailwind`flex flex-row w-full items-center justify-between  `}
            >
              <Text style={tailwind`text-white uppercase`}>Monthly</Text>
        ...
        >
          ...
          <Ionicons
            name="alarm-outline"
            style={tailwind`text-[5rem] text-[#000000]`}
          />
        </TouchableOpacity>
        <DateTimePickerModal
      ...
      <View style={styles.dateTimeContainer}>
        ...
        >
          <Text style={tailwind`text-white uppercase mt-10 text-2xl`}>
            Selected Date -: 
          </Text>
          <Text style={tailwind`text-Black uppercase font-bold text-2xl`}>
        ...
        >
          <Text style={tailwind`text-white uppercase mt-5 text-2xl`}>
            Selected Time -: 
          </Text>
          <Text style={tailwind`text-Black font-bold uppercase text-2xl`}>
